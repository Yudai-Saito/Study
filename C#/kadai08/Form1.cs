...
namespace GuiApp02
{
    ...
    {
        private SalesDetail[] sales_array = new SalesDetail[0];
        private Product[] products_array = new Product[0];
        public Form1()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Array.Resize(ref this.products_array, this.products_array.Length + 1);
                this.products_array[this.products_array.Length - 1] = product;
            }
        }
                ...
                if (product.GetNo() == Convert.ToInt32(textBox4.Text))
                {
                    ...
                    else if (quantity > 999)
                    {
                        ...
                        if (result == DialogResult.Yes)
                        {
                            ...
                            Array.Resize(ref this.sales_array, this.sales_array.Length + 1);
                            this.sales_array[this.sales_array.Length - 1] = sales;
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                foreach(Product product in this.products_array)
                {
                    for(int i = 0; this.sales_array.Length > i; i++)
                    {
